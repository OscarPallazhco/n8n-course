...
The workflow provides employees with a webhook where they can submit a vacation request by specifying:
...
* **n8n webhook nodes** — Endpoints where users can send requests to start or continue the workflow.
...
![RRHH Vacation Workflow](./screenshots/Screenshot_59.png)

---

![RRHH Vacation Workflow](./screenshots/Screenshot_60.png)

---

![RRHH Vacation Workflow](./screenshots/Screenshot_61.png)

---

![RRHH Vacation Workflow](./screenshots/Screenshot_62.png)

---

![RRHH Vacation Workflow](./screenshots/Screenshot_63.png)
